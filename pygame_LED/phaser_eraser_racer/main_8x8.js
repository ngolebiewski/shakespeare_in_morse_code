    ...
    redrawGrid() {
        ...
        for (let y = 0; y < this.gridSize; y++) {
            for (let x = 0; x < this.gridSize; x++) {
                ...
                const rect = this.add.rectangle(this.offsetX + x * this.cellSize, this.offsetY + y * this.cellSize, this.cellSize, this.cellSize, color).setOrigin(0);
                
                // Add a white outline to the active player position
                if (x === this.playerPos.x && y === this.playerPos.y) {
                    this.add.rectangle(this.offsetX + x * this.cellSize + this.cellSize / 2, this.offsetY + y * this.cellSize + this.cellSize / 2, this.cellSize, this.cellSize)
